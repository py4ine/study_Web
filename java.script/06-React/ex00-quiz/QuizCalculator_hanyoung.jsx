...
export default function Calculator (){
    ...
    **/
    ...
    const setVal1 = () => {
        val1 = parseInt(document.getElementById('inputValue1').value);
    }
    ...
    <div>
        ...
        <input type="text" id="inputValue1" onChange={setVal1}></input>
        <input type="text" id="inputValue2" onChange={setVal2}></input>
        <br></br>
        ...
        <button onClick={() => {    if (val2 === 0){
                                        ...
                                        setResult(val1 / val2); setCount(count + 1)
                                    }
                                }}>/</button>
        <br></br>
